...
Sou desenvolvedor **Frontend**, focado em **React, TypeScript e Tailwind CSS**, com atenção a boas práticas, componentização e código limpo. Estou em constante evolução e estudo diário.
...
- 📚 Estudando diariamente Frontend moderno  
- ⚛️ Foco em React + TypeScript  
